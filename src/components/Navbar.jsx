...
export default function Navbar() {
  ...
  return (
    <nav className="fixed top-0 left-0 right-0 z-50 bg-dark/70 backdrop-blur-xl border-b border-dark-border/50">
      <div className="max-w-6xl mx-auto px-4 h-16 flex items-center justify-between">
        <a href="#" className="text-xl font-black gradient-text tracking-tight">
          FC<span className="text-white/30">_</span>
        </a>
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <a href="#" className="ml-2 flex items-center gap-2 px-4 py-2 bg-accent-purple/10 border border-accent-purple/20 rounded-xl text-sm text-accent-purple hover:bg-accent-purple/20 transition-all font-medium">
